...
from gedCom_read import listMarried
...
class TestUserStory(unittest.TestCase):
    ...
    def test_listMarried(self):
        self.assertTrue(listMarried(root_child_elements, root_child_elements[1]))
        self.assertTrue(listMarried(root_child_elements, root_child_elements[2]))
        self.assertTrue(listMarried(root_child_elements, root_child_elements[3]))
        self.assertTrue(listMarried(root_child_elements, root_child_elements[6]))
        self.assertFalse(listMarried(root_child_elements, root_child_elements[10]))
